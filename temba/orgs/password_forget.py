# Password recover rate-limiting is disabled on RapidPro 10.2.0 because UserCRUDL.Forget
# was replaced by django-allauth. Revisit this against the allauth reset flow if needed.
#
